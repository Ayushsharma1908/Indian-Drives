...
import { GovernmentServicesPage, DocumentsCenterPage } from "./pages/services";
import { AppointmentsPage, PaymentsPage, NotificationsPage, HelpCenterPage, ProfilePage, SettingsPage } from "./pages/user";
